...
// Мултиезичен речник за системните бутони и съобщения
const translations = {
    ...
    tr: { subtitle: "Dijital Menü", available: "● Mevcut", empty: "Hepsi", outOfStock: "✕ Tükendi", zoomTip: "İki parmağınızla yakınlaştırabilirsiniz (pinch-to-zoom)", paperTitle: "📄 Kağıt menümüzü görüntüleyin", noItems: "Bu kategoride henüz ürün bulunmamaktadır." }
};
...
function initMenu() {
    ...
    // Режим А: Снимка на хартиено меню
    if (paperMenu) {
        ...
        // Режим Б: Ръчно въведено дигитално меню
            ...
            <div class="p-3 flex flex-col justify-between flex-1 min-w-0">
                <div>
                    <div class="flex justify-between items-start gap-2">
                        ...
                        <!-- Еврото е поставено отпред пред форматираната цена -->
